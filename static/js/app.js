...
function updateFilters() {
    ...
    // 4b. Save the value that was changed as a variable. ( "value of the changed element’s property")
    let elementValue = changedElement.property("value");
    console.log(elementValue);
    // 4c. Save the id of the filter that was changed as a variable.  ("attribute of the changed element’s id")
